...
import { addDays, format } from "date-fns"; // GLOBAL CUSTOM COMPONENTS
    ...
    mb: 4
      ...
      sm: "flex-end"
        ...
        <Paragraph p="0.5rem 1rem" textAlign="center" borderRadius="300px" color="primary.main" bgcolor="primary.light">
          Estimated Delivery Date <b>{format(addDays(new Date(order.createdAt), order._orderDeliveryDays), "dd MMM, yyyy")}</b>
        </Paragraph>
      </FlexBox>
    </Card>;
}