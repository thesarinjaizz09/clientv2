      ...
      <Container>
        <Grid container spacing={3}>
          ...
          <Grid item lg={3} md={3} sm={6} xs={12}>
            ...
            <Paragraph py={0.6}>
              B3-8/A, New Alampur, Shantinagar, Bidhangarh, Kolkata, West Bengal - 700066
            </Paragraph>

            <Paragraph py={0.6}>Email: customersupport@nctenterprises.in</Paragraph>

            <Paragraph py={0.6} mb={2}>
              Phone: +91 933 012 6165
            </Paragraph>
          </Grid>
        </Grid>
        ...
        md: 2
          ...
          <Paragraph>© 2024 By NCT Enterpises. All rights reserved.</Paragraph>
